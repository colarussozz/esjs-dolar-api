...
- [Cobrix](https://www.cobrix.co/): El gestor de pagos y cobros recurrentes #1 de venezuela, durante el proceso de cobro usamos la API para calcular el costo del cobro en VES
